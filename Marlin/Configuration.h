...
#define STRING_CONFIG_H_AUTHOR "(GiMo84, Ender-3 Pro Sprite)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Sprite"
 ...
 *
 */
#define TEMP_SENSOR_0 13  // GiMo84 - Sprite Extruder - possible thermistor, see https://github.com/mriscoc/Ender3V2S1/issues/218
...
#define HEATER_0_MAXTEMP 285  // GiMo84 - Sprite Extruder - all-metal goes up to 300°C
 ...
 */
#if ENABLED(MPCTEMP)
  #define MPC_AUTOTUNE                              // Include a method to do MPC auto-tuning (~5664-5882 bytes of flash)          // GiMo84 - SKR Mini E3 V2
  #define MPC_EDIT_MENU                             // Add MPC editing to the "Advanced Settings" menu. (~1300 bytes of flash)     // GiMo84 - SKR Mini E3 V2
  #define MPC_AUTOTUNE_MENU                         // Add MPC auto-tuning to the "Advanced Settings" menu. (~350 bytes of flash)  // GiMo84 - SKR Mini E3 V2
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 9.5f }            // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.176f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.059f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.067f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9 }  // GiMo84 - Sprite Extruder
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN  // GiMo84 - SKR Mini E3 V2 + BLTouch

// Force the use of the probe for Z-axis homing
#define USE_PROBE_FOR_Z_HOMING  // GiMo84 - SKR Mini E3 V2 + BLTouch
 ...
 */
#define Z_MIN_PROBE_PIN PC14  // GiMo84 - SKR Mini E3 V2 + BLTouch
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, -39, -2.75 }  // GiMo84 - Sprite Extruder
...
#define PROBING_MARGIN 0  // GiMo84 - BLTouch
...
#define EXTRA_PROBING    1  // BLTouch
...
//#define Z_AFTER_PROBING             0 // Z position after probing is done  // GiMo84 forces a Z value after probing is completed. DO NOT ENABLE!
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // GiMo84
 ...
 */
//#define PROBING_HEATERS_OFF         // Turn heaters off when probing  / GiMo84
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 37, 39 } // (mm) Left, Front, Right, Back insets
